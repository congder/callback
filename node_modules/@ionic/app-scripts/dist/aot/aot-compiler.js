        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, runNg5Aot(tsConfig, aggregateCompilerOption, compilerHost)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
...
function runNg5Aot(tsConfig, aggregateCompilerOptions, compilerHost) {
    return __awaiter(this, void 0, void 0, function () {
        var ngTools2, angularCompilerHost, program, transformations, transformers;
        return __generator(this, function (_a) {
            switch (_a.label) {
